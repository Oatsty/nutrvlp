...
def train(config, dataloaders: Dict[str, DataLoader], model: nn.Module, recipe_loss_function: nn.Module, optim1, optim2, scheduler, device):
    ...
    for epoch in range(num_epochs):
        ...
        if epoch < warmup_epochs:
            avg_loss_dict = train_one_epoch(config, dataloaders, model, recipe_loss_function, optim1, device)
        else:
            avg_loss_dict = train_one_epoch(config, dataloaders, model, recipe_loss_function, optim2, device)
...
def main():
    ...
    train(config, dataloaders, model, recipe_loss_function, optim1, optim2, scheduler, device)
