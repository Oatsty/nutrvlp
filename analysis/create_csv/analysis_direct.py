...
def main():
    ...
    for dir2 in dirs:
        ...
        for nutr_name in gts.keys():
            ...
            output_df.loc[dir2,('per 100 g',f'mae@1',nutr_name)] = mae
            output_df.loc[dir2,('per 100 g',f'smape@1',nutr_name)] = smape
        output_df.loc[dir2,('per 100 g',f'smape@1','')] = sum(all_smape)/len(list(gts.keys()))
